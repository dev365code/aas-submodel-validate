...
#: packs, 590 at five, 690 at six, 796 at seven, 883 at eight, 1003 at nine. The bound is raised when it does
#: rather than the
...
class Rule:
    ...
    def __post_init__(self):
        ...
        # 1003 characters (`SMT-D1`'s remedy) and none reaches the bound, so
