...
CONDITIONAL_ON_CATEGORY = (
    ...
    },
    {
        ...
        'citations': ('Annex XIII 4 (a)', 'Annex IV Part A (1)', 'Annex IV (2)'),
    ...
    },
    {
        ...
        'citations': ('Annex XIII 4 (a)', 'Annex IV Part A (4)'),
    ...
    },
    {
        ...
        'citations': ('Annex XIII 1 (k)', 'Annex XIII (1k)'),
        'provision_conditions': (),
    ...
    },
    {
        ...
        'citations': ('Annex XIII 4 (b)', 'Annex VII Part A (1)'),
        'provision_conditions': (),
    ...
    },
    {
        ...
        'citations': ('Annex XIII 4 (b)', 'Art. 10: Annex IV (3) (only definition of power)', 'Annex VII Part A (2) "where possible, remaining power capability"', 'Annex IV Part B (4) --> measurement at 80 % SoC and 20% SoC required'),
