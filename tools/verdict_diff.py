...
def build_corpus(into: Path):
    ...
    # A Product Condition submodel, and one written to 1.0. The first
    # shows IDTA 02035-5 land; the second is the shape docs/divergences.md
    # #58 says a file of 1.0 has: every identifier at SAMM version 1.0.0,
    # so no row matches it and, alone in its file, SMT-D1 says which
    # template it means.
    ...
    earlier = into / "product-condition-written-to-1.0.json"
