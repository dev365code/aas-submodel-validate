...
Every template named for 1.0 has a pack. They were named rather than
...
```
vendored material matches its recorded hashes, and the trees hold nothing else (13 files, pin 11ef33531246)
```
